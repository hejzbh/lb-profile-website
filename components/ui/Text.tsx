...
const sizeClasses = {
  ...
  md: "text-[0.95rem] sm:text-[0.9375rem] md:text-[0.950rem] xl:text-[1.050rem]",
  lg: "text-[1.1rem] sm:text-[1.1rem] md:text-[1.125rem]",
  xl: "text-[1.125rem] sm:text-[1.25rem] md:text-[1.75rem] lg:text-[1.2rem]",
